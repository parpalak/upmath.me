...
return [
	...
	'meta-keywords'    => 'LaTeX, латех, формулы, SVG-картинки, конвертировать формулы на летехе в картинки, markdown latex online editor',
	...
	'faq section' => '
			...
			<p>Вам поможет команда \text. Например, <code>Q_\text{плавления}>0</code> отображается правильно: $$Q_\text{плавления}>0$$.</p>
			...
			<p>Несколько формул удобнее набирать на этой странице. Текст с формулами набирайте в <a href="//tex.s2cms.ru/page/">редакторе с поддержкой маркдаун-разметки</a> и получайте готовый html-код. Сайты с&nbsp;математическими текстами могут использовать сервис напрямую.</p>
	',
	'embedding section 1' => '
