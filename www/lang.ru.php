...
return [
	...
	'embedding section 3' => '
			...
			<p>
				...
				вам может пригодиться <a href="http://s2cms.ru/">движок S2</a>.
				Он <a href="http://s2cms.ru/extension/s2_latex">умеет подключаться</a> к&nbsp;этому сервису без&nbsp;дополнительной настройки.
			</p>
	',
